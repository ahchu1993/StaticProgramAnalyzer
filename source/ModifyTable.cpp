...
vector<Pair<string>> ModifyTable::getModifyPairList(vector<int> set1, vector<int> set2){
	modify_proc_row temp_proc_row;
	modify_stmt_row temp_stmt_row;
	bool flag1 = true;
	bool flag2 = true;
...
bool ModifyTable::checkModify(vector<int> set1, vector<int> set2){
	modify_proc_row temp_proc_row;
	modify_stmt_row temp_stmt_row;
	bool flag1 = true;
	bool flag2 = true;
